...
proc create_root_design { parentCell } {
  ...
  set music [ create_bd_port -dir O music ]
  set music_enable [ create_bd_port -dir O music_enable ]
...
CONFIG.PHASE {0.000} \
  ...
  # Create instance: IMAGE_axi_bram_ctrl_0, and set properties
  set IMAGE_axi_bram_ctrl_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.0 IMAGE_axi_bram_ctrl_0 ]

  # Create instance: IMAGE_blk_mem_gen_0, and set properties
  set IMAGE_blk_mem_gen_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.3 IMAGE_blk_mem_gen_0 ]
  set_property -dict [ list \
CONFIG.Byte_Size {8} \
CONFIG.Coe_File {../../../../imports/ECE532/Coefiles/plane+fire.coe} \
...
CONFIG.use_bram_block {Stand_Alone} \
  ...
  # Create instance: audio_0, and set properties
  set audio_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:audio:1.0 audio_0 ]
...
CONFIG.DOUT_WIDTH {4} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins IMAGE_axi_bram_ctrl_0/BRAM_PORTA] [get_bd_intf_pins IMAGE_blk_mem_gen_0/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTB [get_bd_intf_pins IMAGE_axi_bram_ctrl_0/BRAM_PORTB] [get_bd_intf_pins IMAGE_blk_mem_gen_0/BRAM_PORTB]
  ...
  connect_bd_intf_net -intf_net gpio_led_GPIO [get_bd_intf_ports led_16bits] [get_bd_intf_pins gpio_led/GPIO]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins gpio_led/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M06_AXI [get_bd_intf_pins IMAGE_axi_bram_ctrl_0/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M07_AXI [get_bd_intf_pins game_engine_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M07_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M08_AXI [get_bd_intf_pins axi_uartlite_2/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M08_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M09_AXI [get_bd_intf_pins audio_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M09_AXI]
  ...
  # Create port connections
  connect_bd_net -net audio_0_music [get_bd_ports music] [get_bd_pins audio_0/music]
  connect_bd_net -net audio_0_music_enable [get_bd_ports music_enable] [get_bd_pins audio_0/music_enable]
  ...
  connect_bd_net -net axi_uartlite_1_tx [get_bd_ports uart_txd] [get_bd_pins axi_uartlite_1/tx]
  connect_bd_net -net axi_uartlite_2_interrupt [get_bd_pins axi_uartlite_2/interrupt] [get_bd_pins microblaze_0_xlconcat/In2]
  connect_bd_net -net axi_uartlite_2_tx [get_bd_ports tx] [get_bd_pins axi_uartlite_2/tx]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins audio_0/s00_axi_aclk] [get_bd_pins axi_tft_0/m_axi_aclk] [get_bd_pins axi_tft_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins axi_uartlite_1/s_axi_aclk] [get_bd_pins axi_uartlite_2/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins game_engine_0/s00_axi_aclk] [get_bd_pins gpio_led/s_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M07_ACLK] [get_bd_pins microblaze_0_axi_periph/M08_ACLK] [get_bd_pins microblaze_0_axi_periph/M09_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_axi_periph/S01_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  ...
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins IMAGE_axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_81M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins audio_0/s00_axi_aresetn] [get_bd_pins axi_tft_0/m_axi_aresetn] [get_bd_pins axi_tft_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins axi_uartlite_1/s_axi_aresetn] [get_bd_pins axi_uartlite_2/s_axi_aresetn] [get_bd_pins game_engine_0/s00_axi_aresetn] [get_bd_pins gpio_led/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/M07_ARESETN] [get_bd_pins microblaze_0_axi_periph/M08_ARESETN] [get_bd_pins microblaze_0_axi_periph/M09_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S01_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
  connect_bd_net -net rst_mig_7series_0_81M_peripheral_aresetn [get_bd_pins IMAGE_axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins rst_mig_7series_0_81M/peripheral_aresetn]
  connect_bd_net -net rx_1 [get_bd_ports rx] [get_bd_pins axi_uartlite_2/rx]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_1/clk_in1]
  connect_bd_net -net uart_rxd_1 [get_bd_ports uart_rxd] [get_bd_pins axi_uartlite_1/rx]
  connect_bd_net -net xlslice_0_Dout [get_bd_ports VGA_RED] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_ports VGA_GREEN] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_ports VGA_BLUE] [get_bd_pins xlslice_2/Dout]

  # Create address segments
  create_bd_addr_seg -range 0x00008000 -offset 0xC0000000 [get_bd_addr_spaces axi_tft_0/Video_data] [get_bd_addr_segs IMAGE_axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A20000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs audio_0/S00_AXI/S00_AXI_reg] SEG_audio_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00008000 -offset 0xC0000000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs IMAGE_axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A10000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs game_engine_0/S00_AXI/S00_AXI_reg] SEG_game_engine_0_S00_AXI_reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A20000 [get_bd_addr_spaces axi_tft_0/Video_data] [get_bd_addr_segs audio_0/S00_AXI/S00_AXI_reg] SEG_audio_0_S00_AXI_reg
  exclude_bd_addr_seg [get_bd_addr_segs axi_tft_0/Video_data/SEG_audio_0_S00_AXI_reg]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40620000 [get_bd_addr_spaces axi_tft_0/Video_data] [get_bd_addr_segs axi_uartlite_2/S_AXI/Reg] SEG_axi_uartlite_2_Reg
  exclude_bd_addr_seg [get_bd_addr_segs axi_tft_0/Video_data/SEG_axi_uartlite_2_Reg]
...
#  -string -flagsOSRD
preplace port tx -pg 1 -y 1350 -defaultsOSRD
preplace port uart_txd -pg 1 -y 1160 -defaultsOSRD
preplace port led_16bits -pg 1 -y 760 -defaultsOSRD
preplace port music -pg 1 -y 870 -defaultsOSRD
preplace port VGA_VS -pg 1 -y 270 -defaultsOSRD
preplace port rx -pg 1 -y 1270 -defaultsOSRD
preplace port sys_clock -pg 1 -y 730 -defaultsOSRD
preplace port DDR2 -pg 1 -y 430 -defaultsOSRD
preplace port usb_uart -pg 1 -y 990 -defaultsOSRD
preplace port uart_rxd -pg 1 -y 1240 -defaultsOSRD
preplace port music_enable -pg 1 -y 890 -defaultsOSRD
preplace port VGA_HS -pg 1 -y 170 -defaultsOSRD
preplace port reset -pg 1 -y 640 -defaultsOSRD
preplace portBus VGA_RED -pg 1 -y 220 -defaultsOSRD
preplace portBus VGA_BLUE -pg 1 -y 40 -defaultsOSRD
preplace portBus VGA_GREEN -pg 1 -y 120 -defaultsOSRD
preplace inst axi_tft_0 -pg 1 -lvl 4 -y 190 -defaultsOSRD
preplace inst xlslice_0 -pg 1 -lvl 7 -y 220 -defaultsOSRD
preplace inst IMAGE_blk_mem_gen_0 -pg 1 -lvl 7 -y 330 -defaultsOSRD
preplace inst gpio_led -pg 1 -lvl 6 -y 760 -defaultsOSRD
preplace inst xlslice_1 -pg 1 -lvl 7 -y 120 -defaultsOSRD
preplace inst mig_7series_0 -pg 1 -lvl 6 -y 470 -defaultsOSRD
preplace inst xlslice_2 -pg 1 -lvl 7 -y 40 -defaultsOSRD
preplace inst rst_mig_7series_0_81M -pg 1 -lvl 4 -y 450 -defaultsOSRD
preplace inst microblaze_0_axi_periph -pg 1 -lvl 5 -y 700 -defaultsOSRD
preplace inst microblaze_0_xlconcat -pg 1 -lvl 2 -y 1170 -defaultsOSRD
preplace inst audio_0 -pg 1 -lvl 6 -y 880 -defaultsOSRD
preplace inst mdm_1 -pg 1 -lvl 3 -y 1010 -defaultsOSRD
preplace inst microblaze_0_axi_intc -pg 1 -lvl 3 -y 850 -defaultsOSRD
preplace inst IMAGE_axi_bram_ctrl_0 -pg 1 -lvl 6 -y 330 -defaultsOSRD
preplace inst axi_uartlite_0 -pg 1 -lvl 6 -y 1000 -defaultsOSRD
preplace inst microblaze_0 -pg 1 -lvl 4 -y 1010 -defaultsOSRD
preplace inst game_engine_0 -pg 1 -lvl 6 -y 640 -defaultsOSRD
preplace inst axi_uartlite_1 -pg 1 -lvl 6 -y 1150 -defaultsOSRD
preplace inst rst_clk_wiz_1_100M -pg 1 -lvl 2 -y 940 -defaultsOSRD
preplace inst axi_uartlite_2 -pg 1 -lvl 6 -y 1340 -defaultsOSRD
preplace inst clk_wiz_1 -pg 1 -lvl 1 -y 720 -defaultsOSRD
preplace inst microblaze_0_local_memory -pg 1 -lvl 5 -y 1160 -defaultsOSRD
preplace netloc audio_0_music_enable 1 6 2 NJ 890 NJ
preplace netloc axi_uartlite_2_interrupt 1 1 6 220 1240 NJ 1240 NJ 1240 NJ 1240 NJ 1240 2070
preplace netloc rx_1 1 0 7 NJ 1260 NJ 1260 NJ 1260 NJ 1260 NJ 1260 NJ 1260 2060
preplace netloc mig_7series_0_mmcm_locked 1 3 4 850 340 NJ 240 NJ 240 2080
preplace netloc mig_7series_0_DDR2 1 6 2 NJ 430 NJ
preplace netloc microblaze_0_axi_periph_M08_AXI 1 5 1 1720
preplace netloc microblaze_0_axi_periph_M04_AXI 1 5 1 1740
preplace netloc audio_0_music 1 6 2 NJ 870 NJ
preplace netloc axi_uartlite_1_interrupt 1 1 6 190 1080 NJ 1080 NJ 1090 NJ 1070 NJ 1230 2060
preplace netloc xlslice_1_Dout 1 7 1 NJ
preplace netloc axi_tft_0_tft_vga_b 1 4 3 NJ 40 NJ 40 NJ
preplace netloc gpio_led_GPIO 1 6 2 NJ 760 NJ
preplace netloc axi_uartlite_0_interrupt 1 1 6 220 1100 NJ 1100 NJ 1100 NJ 1060 NJ 1070 2060
preplace netloc microblaze_0_intr 1 2 1 590
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 6 1 N
preplace netloc microblaze_0_Clk 1 1 5 200 750 580 750 840 550 1390 360 1750
preplace netloc axi_bram_ctrl_0_BRAM_PORTB 1 6 1 N
preplace netloc microblaze_0_axi_periph_M06_AXI 1 5 1 1780
preplace netloc microblaze_0_axi_periph_M03_AXI 1 3 3 840 50 NJ 50 1740
preplace netloc microblaze_0_intc_axi 1 2 4 590 60 NJ 60 NJ 60 1720
preplace netloc microblaze_0_interrupt 1 3 1 830
preplace netloc axi_tft_0_tft_hsync 1 4 4 NJ 170 NJ 170 NJ 170 NJ
preplace netloc axi_tft_0_tft_vga_r 1 4 3 NJ 210 NJ 210 NJ
preplace netloc microblaze_0_ilmb_1 1 4 1 1310
preplace netloc axi_tft_0_tft_vsync 1 4 4 NJ 220 NJ 220 NJ 270 NJ
preplace netloc sys_clock_1 1 0 1 NJ
preplace netloc microblaze_0_axi_periph_M05_AXI 1 5 1 1800
preplace netloc microblaze_0_axi_dp 1 4 1 1380
preplace netloc axi_tft_0_tft_vga_g 1 4 3 NJ 120 NJ 120 NJ
preplace netloc mig_7series_0_ui_clk 1 3 4 860 540 1410 310 1770 260 2060
preplace netloc rst_mig_7series_0_81M_peripheral_aresetn 1 4 2 1330 340 1810
preplace netloc rst_clk_wiz_1_100M_interconnect_aresetn 1 2 3 NJ 360 NJ 360 1350
preplace netloc rst_clk_wiz_1_100M_bus_struct_reset 1 2 3 NJ 730 NJ 730 1320
preplace netloc microblaze_0_axi_periph_M01_AXI 1 5 1 1790
preplace netloc axi_uartlite_1_tx 1 6 2 NJ 1160 NJ
preplace netloc xlslice_2_Dout 1 7 1 NJ
preplace netloc rst_clk_wiz_1_100M_peripheral_aresetn 1 2 4 550 330 810 330 1340 330 1760
preplace netloc rst_clk_wiz_1_100M_mb_reset 1 2 2 540 950 820
preplace netloc clk_wiz_1_locked 1 1 1 190
preplace netloc axi_uartlite_0_UART 1 6 2 NJ 990 NJ
preplace netloc axi_uartlite_2_tx 1 6 2 NJ 1350 NJ
preplace netloc clk_wiz_1_clk_out2 1 1 5 NJ 320 NJ 320 NJ 320 NJ 320 1820
preplace netloc mig_7series_0_ui_clk_sync_rst 1 3 4 870 350 NJ 250 NJ 250 2070
preplace netloc microblaze_0_axi_periph_M07_AXI 1 5 1 1820
preplace netloc microblaze_0_axi_periph_M02_AXI 1 5 1 1810
preplace netloc microblaze_0_dlmb_1 1 4 1 1350
preplace netloc clk_wiz_1_clk_out3 1 1 3 NJ 240 NJ 240 N
preplace netloc axi_tft_0_M_AXI_MM 1 4 1 1370
preplace netloc microblaze_0_debug 1 3 1 N
preplace netloc reset_1 1 0 6 20 640 210 640 NJ 640 NJ 640 NJ 370 1800
preplace netloc mdm_1_debug_sys_rst 1 1 3 220 710 NJ 710 810
preplace netloc microblaze_0_axi_periph_M09_AXI 1 5 1 1730
preplace netloc uart_rxd_1 1 0 7 NJ 1240 NJ 1250 NJ 1250 NJ 1250 NJ 1250 NJ 1250 2080
preplace netloc xlslice_0_Dout 1 7 1 NJ
levelinfo -pg 1 0 100 380 700 1090 1560 1940 2200 2320 -top 0 -bot 1420
",
}
